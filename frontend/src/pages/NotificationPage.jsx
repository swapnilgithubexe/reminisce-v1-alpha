...
const NotificationPage = () => {
  ...
  const { data: friendRequests, isLoading } = useQuery({
    ...
    //! this fx gives all the requests, filter can be applied on status of the request
  });
  ...
  const { mutate: acceptRequestMutation, isPending } = useMutation({
    ...
    onSuccess: () => {
      ...
      //! once accpeted, the UI needs to be updated quickly
  ...
  //! we could have de structed it but adding a null check wont break the code, and added fallback for accepted requests
